...
extension Contact {
    ...
    convenience init(withName nom: String, withPrenom prenom: String?, withTelephone telephone : String?, withAdresse adresse : String?, is_a type: TypeContact, is_connected_to patient: Patient){
