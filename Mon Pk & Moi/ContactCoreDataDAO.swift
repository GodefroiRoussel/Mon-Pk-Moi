...
class ContactCoreDataDAO : ContactDAO {
    ...
    func create(withName nom: String, withPrenom prenom: String?, withTelephone telephone: String?, withAdresse adresse: String?, is_a typeContact: TypeContact ) throws -> Contact {
